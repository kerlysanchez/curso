//SEMANA1, Código de la sesión de asesorías del Módulo 2
...
//if - Comparará si la práctica 2 es menor a califMenor, 
//si lo es, convierte la practica 2 a la calificación más baja
if( practicaN2 < califMenor ){
    califMenor = practicaN2;
}
//else if - Comparará si la práctica 3 es menor a califMenor, 
//si lo es, convierte la practica 3 a la calificación más baja
else if( practicaN3 < califMenor ){
    califMenor = practicaN3;
}
//else - Si las condiciones anteriores no se han cumplido, 
//convierte la práctica 4 a la calificación más baja
else if( practicaN4 < califMenor ){
    califMenor = practicaN4;
}

//Calculamos el promedio, pero restamos la calificación menor 
